...
rm(list=ls())
load(file='GSE57830_new_exprSet.Rdata')
exprSet=new_exprSet
dim(exprSet)
group_list
exprSet=exprSet[,c(1:3,19:21)]
group_list=group_list[c(1:3,19:21)]
...
contrast.matrix<-makeContrasts(paste0(unique(group_list),collapse = "-"),
                               levels = design)
contrast.matrix<-makeContrasts("SIRT6_ZT_0-WT_ZT_0",
                               levels = design)
